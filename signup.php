    	...
    	<form action="register.php" method="POST">
          ...
          <div class="form-group has-feedback">
            ...
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
      		...
      		<div class="form-group has-feedback">
        		<input type="email" class="form-control" name="email" placeholder="Correo electronico" value="<?php echo (isset($_SESSION['email'])) ? $_SESSION['email'] : '' ?>" required>
          ...
          <hr>
      		<div class="row">
    			<div class="col-xs-4">
          			<button type="submit" class="btn btn-primary btn-block btn-flat" name="signup"><i class="fa fa-pencil"></i>Entrar</button>
        		</div>
      		</div>
    	</form>
      <br>
